...
#define SIM_SERIAL_TYPE	HardwareSerial
...
#define SIM_BAUD 115200		//Slow, but safe
// if the number of errors reaches this number, reset the SIM module
#define MAX_ERRORS_TO_RESET 20
...
#pragma region GPRS
	...
	boolean requestHTTP(RequestMethod method, String * host, String * parameters = nullptr, uint16_t* resultCode = nullptr, String* serviceResponse = nullptr);
...
#endif
		delay(1000);
		uint32_t baudArray[] = { 38400, 115200, 9600, 57600 };
		char c;
